...
export const FIELD_HELP = {
  ...
  HasUltimate: "True when a pact ultimate is unlocked. Pair with Ultimate perk + skull item.",
  ...
  UltimateSkullItemId: "Skull item id that grants the ultimate (e.g. skull_mars_solar_flare). Empty object {} means none.",
